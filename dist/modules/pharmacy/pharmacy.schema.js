...
exports.createPrescriptionSchema = zod_1.z.object({
    encounterId: zod_1.z.string().min(1, { message: 'Encounter ID is required' }),
    patientId: zod_1.z.string().min(1, { message: 'Patient ID is required' }),
...
exports.createSaleSchema = zod_1.z.object({
    ...
    items: zod_1.z.array(zod_1.z.object({
        ...
        sellLoose: zod_1.z.preprocess((val) => typeof val === 'number' ? Boolean(val) : val, zod_1.z.boolean().optional().default(false)),
